...
public sealed class DeclarationComparerOptions
{
	...
	public static DeclarationComparerOptions FromAnalyzerConfigOptions(AnalyzerConfigOptions options)
	{
		...
		foreach (var property in typeof(DeclarationComparerOptions).GetProperties())
		{
			...
			{
				nameof(AccessibilityOrder) => DiagnosticIds.AccessibilityPrefix,
				nameof(IdentifierNames) => DiagnosticIds.IdentifierPrefix,
				nameof(ArityOrder) => DiagnosticIds.ArityPrefix,
				nameof(ExplicitInterfaceSpecifiers) => DiagnosticIds.ExplicitInterfacePrefix,
				nameof(FieldOrder) => DiagnosticIds.FieldPrefix,
				nameof(KindOrder) => DiagnosticIds.KindPrefix,
				nameof(MergeEvents) => DiagnosticIds.KindPrefix,
				nameof(OperatorOrder) => DiagnosticIds.IdentifierPrefix,
				nameof(ParameterNames) => DiagnosticIds.ParameterNamePrefix,
				nameof(ParameterTypeNames) => DiagnosticIds.ParameterTypePrefix,
				nameof(ReferenceParameterOrder) => DiagnosticIds.ParameterTypePrefix,
				nameof(SortOrders) => DiagnosticIds.SharedPrefix,
				nameof(Static) => DiagnosticIds.StaticPrefix,
				nameof(UnknownAccessibilityOrder) => DiagnosticIds.AccessibilityPrefix,
				nameof(UnknownFieldMutabilityOrder) => DiagnosticIds.FieldPrefix,
				nameof(UnknownKindOrder) => DiagnosticIds.KindPrefix,
				nameof(UnknownOperatorTokenOrder) => DiagnosticIds.IdentifierPrefix,
