...
public class UnitTests : XunitDiagnosticVerifier<MemberSorterAnalyzer, FixOneCodeFixProvider>
{
	...
	private static string MakePropertyKey<T>(System.Linq.Expressions.Expression<Func<DeclarationComparerOptions, T>> expression)
	{
		...
		foreach (var property in typeof(DeclarationComparerOptions).GetProperties())
		{
			...
			{
				nameof(DeclarationComparerOptions.AccessibilityOrder) => DiagnosticIds.AccessibilityPrefix,
				nameof(DeclarationComparerOptions.IdentifierNames) => DiagnosticIds.IdentifierPrefix,
				nameof(DeclarationComparerOptions.ArityOrder) => DiagnosticIds.ArityPrefix,
				nameof(DeclarationComparerOptions.ExplicitInterfaceSpecifiers) => DiagnosticIds.ExplicitInterfacePrefix,
				nameof(DeclarationComparerOptions.FieldOrder) => DiagnosticIds.FieldPrefix,
				nameof(DeclarationComparerOptions.KindOrder) => DiagnosticIds.KindPrefix,
				nameof(DeclarationComparerOptions.MergeEvents) => DiagnosticIds.KindPrefix,
				nameof(DeclarationComparerOptions.OperatorOrder) => DiagnosticIds.IdentifierPrefix,
				nameof(DeclarationComparerOptions.ParameterNames) => DiagnosticIds.ParameterNamePrefix,
				nameof(DeclarationComparerOptions.ParameterTypeNames) => DiagnosticIds.ParameterTypePrefix,
				nameof(DeclarationComparerOptions.ReferenceParameterOrder) => DiagnosticIds.ParameterTypePrefix,
				nameof(DeclarationComparerOptions.SortOrders) => DiagnosticIds.SharedPrefix,
				nameof(DeclarationComparerOptions.Static) => DiagnosticIds.StaticPrefix,
				nameof(DeclarationComparerOptions.UnknownAccessibilityOrder) => DiagnosticIds.AccessibilityPrefix,
				nameof(DeclarationComparerOptions.UnknownFieldMutabilityOrder) => DiagnosticIds.FieldPrefix,
				nameof(DeclarationComparerOptions.UnknownKindOrder) => DiagnosticIds.KindPrefix,
				nameof(DeclarationComparerOptions.UnknownOperatorTokenOrder) => DiagnosticIds.IdentifierPrefix,
